...
const LeTueGarePage: React.FC<LeTueGarePageProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="sticky top-[var(--header-top)] z-40 bg-slate-950/95 backdrop-blur-xl -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-1.5 sm:py-2 space-y-1.5 sm:space-y-2 border-b border-slate-900/50 shadow-2xl transition-all duration-300">
