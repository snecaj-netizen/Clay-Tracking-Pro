...
export const BibPrintSheet: React.FC<BibPrintSheetProps> = ({ shooter, competitionName, societyName }) => {
  return (
    <div className="printable-bib p-16 flex flex-col border-[8px] border-slate-900 bg-white text-black mx-auto relative shadow-none box-border" style={{ width: '297mm', height: '210mm', minHeight: '210mm', pageBreakAfter: 'always', breakAfter: 'page', boxSizing: 'border-box' }}>
