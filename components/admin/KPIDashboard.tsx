    ...
    <div className="mb-8 animate-in fade-in zoom-in duration-300">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-slate-950/50 border border-slate-800 p-3 sm:p-4 rounded-2xl">
          <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
            ...
            <span className="hidden sm:inline text-[10px] font-black text-slate-500 uppercase tracking-widest">Traffico Generato (Tiratore)</span>
          </div>
          <div className="text-sm font-bold text-white truncate">
            {stats.topUserName}
          </div>
          <div className="text-[10px] text-slate-500 font-bold uppercase mt-1">
            {stats.topUserTraffic} Attività
          </div>
        </div>
        <div className="bg-slate-950/50 border border-slate-800 p-3 sm:p-4 rounded-2xl">
          <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
            ...
            <span className="hidden sm:inline text-[10px] font-black text-slate-500 uppercase tracking-widest">Traffico Generato (Società)</span>
          </div>
          <div className="text-sm font-bold text-white truncate">
            {stats.topSocName}
          </div>
          <div className="text-[10px] text-slate-500 font-bold uppercase mt-1">
            {stats.topSocTraffic} Attività
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-3 sm:mt-4">
        <div className="bg-slate-950/50 border border-slate-800 p-3 sm:p-4 rounded-2xl">
          ...
          <div className="text-[10px] text-slate-500 font-bold uppercase mt-1">
            {stats.topUserResultsCount} Gare Inserite
          </div>
        </div>
        <div className="bg-slate-950/50 border border-slate-800 p-3 sm:p-4 rounded-2xl">
          <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
          ...
          <div className="text-[10px] text-slate-500 font-bold uppercase mt-1">
            {stats.topSocResultsCount} Gare Totali
          </div>
        </div>
        <div className="bg-slate-950/50 border border-slate-800 p-3 sm:p-4 rounded-2xl">
          <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
            ...
            <span className="hidden sm:inline text-[10px] font-black text-slate-500 uppercase tracking-widest">Top User (Piattelli Sparati)</span>
          </div>
          <div className="text-sm font-bold text-white truncate">
            {stats.topUserByTargetsName}
          </div>
          <div className="text-[10px] text-slate-500 font-bold uppercase mt-1">
            {stats.topUserTargetsTotal} Piattelli
          </div>
        </div>
