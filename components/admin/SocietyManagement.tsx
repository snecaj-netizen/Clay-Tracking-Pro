...
const SocietyManagement: React.FC<SocietyManagementProps> = ({
  ...
  return (
    <div className="space-y-2">
      <div className="sticky top-[var(--header-top)] z-30 bg-slate-950/95 backdrop-blur-xl -mx-4 px-4 py-2 sm:py-3 border-b border-slate-900/50 shadow-2xl transition-all duration-300">
