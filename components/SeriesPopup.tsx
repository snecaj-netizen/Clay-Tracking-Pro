...
const SeriesPopup: React.FC<SeriesPopupProps> = ({ competition, seriesIndex, onClose, onSave }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[1200] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300" onClick={onClose}>
